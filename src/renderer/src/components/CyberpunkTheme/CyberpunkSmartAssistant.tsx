          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-black/30 backdrop-blur-sm border border-red-500/30 rounded-lg group hover:border-red-500/60 transition-colors p-4">
              <div className="flex justify-between items-center">
                <h2 className="text-xs text-red-500 tracking-widest">MONTHLY COST</h2>
            ...
            <div className="bg-black/30 backdrop-blur-sm border border-red-500/30 rounded-lg group hover:border-red-500/60 transition-colors p-4">
              ...
              <div className="text-xs text-gray-500 mt-1">
                {income > 0 ? `${(calculateAnnualSubscriptionCost() / income * 100).toFixed(1)}% of income` : 'Add income data'}
              </div>
            </div>
          </div>
        </header>
