...
const EnhancedThemeSwitcher: React.FC = () => {
  const { themeType, setTheme, isDashboardLayout, toggleDashboardLayout } = useTheme();
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      {/* Theme menu */}
      {isOpen && (
        <div className={`${themeType === 'cyberpunk' ? 'bg-black/70 border border-red-500/30' : 'bg-white shadow-lg'} rounded-lg p-3 mb-2`}>
          <div className="mb-3">
            <h3 className={`text-sm font-bold mb-2 ${themeType === 'cyberpunk' ? 'text-red-500' : 'text-gray-700'}`}>
              Theme
            </h3>
